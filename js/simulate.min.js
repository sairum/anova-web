...
factors.push(f);computeLevels(0);recodeNestedFactors();setupLevels(fnum);fname.value="";levels.value=2;ftype.value='fixed';nestedin.value='-';let elem=document.getElementById("generate");elem.disabled=false;}else{console.log('good but duplicated name:'+name)}}else{console.log('bad name:'+name)}}
